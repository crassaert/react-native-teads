...
public class RNTeadsManager extends SimpleViewManager<CustomInReadAdView> {
  ...
  public void enableDebug(CustomInReadAdView view, @Nullable Boolean enableValidationMode) {
